...
tag: package-2021-08-15-preview
```
...
These settings apply only when `--tag=package-2021-08-15-preview` is specified on the command line.

```yaml $(tag) == 'package-2021-08-15-preview'
input-file:
  - preview/2021-08-15-preview/communicationservicescallingserver.json
title:
  Azure Communication Services
```
